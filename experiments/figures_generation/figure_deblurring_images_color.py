...
for image in images:
    ...
    degraded = Image.open(os.path.join(RESULTS, f"{image}_blurred.png"))
    tv = Image.open(os.path.join(RESULTS, f"{image}_tv.png"))
    wavelets = Image.open(os.path.join(RESULTS, f"{image}_wavelets.png"))
    cdl = Image.open(os.path.join(RESULTS, f"{image}_cdl.png"))
    dip = Image.open(os.path.join(RESULTS, f"{image}_dip.png"))
    ...
    fig.set_figheight(6)
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURES, f"deblurring_color_zoom_{image}.pdf"))
    # %%
