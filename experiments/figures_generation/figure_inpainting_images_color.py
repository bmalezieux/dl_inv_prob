...
degraded = Image.open(os.path.join(RESULTS, f"corrupted_0.50_{noise_level:.2f}.png"))
tv = Image.open(os.path.join(RESULTS, f"tv_0.50_{noise_level:.2f}.png"))
wavelets = Image.open(os.path.join(RESULTS, f"wavelets_0.50_{noise_level:.2f}.png"))
cdl = Image.open(os.path.join(RESULTS, f"cdl_0.50_{noise_level:.2f}.png"))
dip = Image.open(os.path.join(RESULTS, f"dip_0.50_{noise_level:.2f}.png"))
...
fig.set_figheight(6)
plt.tight_layout()
plt.savefig(os.path.join(FIGURES, f"inpainting_color_zoom_{noise_level:.2f}.pdf"))
# %%
